        ...
        <div class="collapse navbar-collapse" id="navcol-1"
            ...
            ?>
                    <?php if ($_SESSION['isowner']) {
                        ?>
                    <li class="nav-item"><a class="nav-link hide active" href="addhotel.php">Dashboard</a></li>     
                      <?php
        } ?>
...
<div class="col-12 d-flex mt-3">
    <div class="container-fluid d-flex justify-content-center">
        ...
        <form class="col-md-12 col-sm-12 col-lg-8" method="post" action="../process//process_hotel.php" enctype="multipart/form-data">
            <div class="card shadow mb-3">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="city"><strong>Location</strong></label>
                        <label>
                            <select class="form-select" name="location" required>
                                ...
                                foreach ($allLocations as $loc) {
                                    ...
                                    echo "<option value='$country:$city'>$country, $city</option>";
                                }
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="price_per_night"><strong>Price per Night</strong></label>
                        <input class="form-control" type="number" id="price_per_night" name="price_per_night" min="0" step="0.01" required>
                    </div>

                    <div class="mb-3">
                        <label for="amenities"><strong>Amenities:</strong></label><br>
                        <input type="checkbox" id="wifi" name="amenities[]" value="Free WiFi" >
                        ...
                        <input type="checkbox" id="gym" name="amenities[]" value="Fitness Gym" >
                        <label for="gym">Fitness Gym</label><br>
                    </div>

                    <div class="mb-3">
                        <label class="form-label" for="image_upload"><strong>Upload Hotel Image</strong></label>
                        <input class="form-control" type="file" id="image_upload" name="image_upload_1" accept="image/jpeg" required>
                        <input class="form-control" type="file" id="image_upload" name="image_upload_2" accept="image/jpeg" required>
                    </div>
