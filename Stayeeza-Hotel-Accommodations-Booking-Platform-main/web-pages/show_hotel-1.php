...
<head>
    ...
    <link rel="stylesheet" href="../css/styles-reviews.css">
                                                        ...
                                                        <div class="card-body"
                                                            ...
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <button class="btn btn-primary btn-d d-flex align-items-center"
                                                                        ...
                                                                        style="border-radius: 56px; width: 100%; font-size: 15px; margin-right: 10px;">
                                                                    <strong>Book Now</strong>&nbsp;<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -64 640 640" width="1em" height="1em" fill="currentColor">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="row" style="padding: 20px;">
                                                                <div class="col">
                                                                    <div class="card">
                                                                        <div class="card-header">
                                                                            <h5 class="card-title">Hotel Rooms Details</h5>
                                                                        </div>
                                                                        <div class="card-body">
                                                            <div>

                                                                <?php
                                                                $hotels_room_det = $hotel->showHotelRooms( $result['hotel_id']);
                                                                ?>
            ...
            ?>
			  <!--  Comment Box start--->
                            ...
                            <?php 
                                ...
                                <img src="../userProPic/<?php echo $results["profilePic"]; ?>" alt="Comment Images"> 
                                </div>
                                <?php
                                                                    } else {
                                                                        ?>
                            ...
                            <div class="comment-content">
                                <div class="comment-top">
                                    ...
                                    <div class="rating"> 
                                    <?php
                                    if($results["user_rating"]==5){
                                        for($i=0;$i<5;$i++){
                                            ?>
                                                <i class="fa fa-star" aria-hidden="true"></i>
                                            <?php
                                        }
                                    }else if($results["user_rating"]==4){
                                    ?>
                                    <?php
                            ...
                            ?>
                                ...
                                <h6 class="title"><?php echo $results["userFirstName"]; ?> <?php echo $results["userLastName"]; ?></h6>
                                <p><?php echo $results["user_review"]; ?></p>
                            </div>
                            </div>
			  <!-- Comment Box end--->
			  <?php
